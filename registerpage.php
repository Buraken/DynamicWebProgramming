        ...
        <div class="form-container">
            <div>
                <form action="register.php" method="POST" >
                    ...
                    <br>
                    <br>
                    <input type="submit" id="sign-in" value="Kayıt Ol">
                </form>
            </div>
            <div class="sign-in-container"><button id="login" onclick="window.location.href = 'loginpage.php'">Giriş Yap</button></div>
