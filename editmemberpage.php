...
<body>
    ...
    <form action="editmember.php" method="POST" >
        <label>Adı:</label>  <input class="login-box" type="text" name="name" placeholder="<?php echo $adi;?>">
        <label>Soyadı:</label>  <input class="login-box" type="text" name="surname" placeholder="<?php echo $soyadi;?>">
        <label>Mail:</label>  <input class="login-box" type="text" name="mail" placeholder="<?php echo $mail;?>">
        <label>Doğum Yılı:</label>  <input class="login-box" type="text" name="birthyear" placeholder="<?php echo $yil;?>">
